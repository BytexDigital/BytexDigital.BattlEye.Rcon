...
namespace BytexDigital.BattlEye.Rcon.Commands
{
    ...
    {
        /// <summary>
        /// Requests the server to change the rcon password to the specified one immediately. Currently authenticated <see cref="RconClient"/>s will stay authenticated.
        /// </summary>
